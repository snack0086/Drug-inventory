...
## 📦 Complete Modular Documentation Index

All detailed specifications, schemas, domain models, and technical guides are located in the [`Plan and Documentation`](./Plan%20and%20Documentation/) folder. Click on any module below to inspect its dedicated README:

### High-Level Architecture
* **[12. Complete System Architecture & Sequence Flows](./Plan%20and%20Documentation/12_README_SYSTEM_ARCHITECTURE.md)** — Architectural blueprint, C4 micro-services topology, and end-to-end sequence diagrams.

### Core Supply Chain Modules
1. **[01. Drug & Batch Master Management](./Plan%20and%20Documentation/01_README_DRUG_AND_BATCH_MASTER.md)**
   * Drug master catalog, categorization, minimum/target thresholds, batch lifecycle, manufacturing, and batch expiry tracking.
2. **[02. Procurement & Vendor Management](./Plan%20and%20Documentation/02_README_PROCUREMENT_AND_VENDOR_MANAGEMENT.md)**
...
3. **[03. Inventory Intelligence & Multi-Echelon Stock](./Plan%20and%20Documentation/03_README_INVENTORY_INTELLIGENCE.md)**
...
4. **[04. Distribution & Supply Chain Movement Tracking](./Plan%20and%20Documentation/04_README_DISTRIBUTION_AND_TRACKING.md)**
...
5. **[05. Hospital Consumption & Demand Intelligence](./Plan%20and%20Documentation/05_README_HOSPITAL_CONSUMPTION.md)**
...
6. **[06. Quality & Expiry Management](./Plan%20and%20Documentation/06_README_QUALITY_AND_EXPIRY_MANAGEMENT.md)**
...
7. **[07. Hospital Risk & Need Scoring Engine (⭐ Core Innovation)](./Plan%20and%20Documentation/07_README_HOSPITAL_RISK_ENGINE.md)**
...
8. **[08. Intelligent Inter-Facility Redistribution Engine (⭐⭐⭐ Core Innovation)](./Plan%20and%20Documentation/08_README_INTELLIGENT_REDISTRIBUTION.md)**
...
9. **[09. Near-Expiry Redistribution & Wastage Elimination (⭐⭐⭐ Core Innovation)](./Plan%20and%20Documentation/09_README_NEAR_EXPIRY_REDISTRIBUTION.md)**
...
10. **[10. Multi-Role Tailored Dashboards](./Plan%20and%20Documentation/10_README_MULTI_ROLE_DASHBOARDS.md)**
...
11. **[11. Common Infrastructure: RBAC, Audit, Alerts & Analytics](./Plan%20and%20Documentation/11_README_COMMON_INFRASTRUCTURE.md)**
